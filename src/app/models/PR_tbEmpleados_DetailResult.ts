export interface PR_tbEmpleados_DetailResult {
    emp_Id: number | null;
    emp_Codigo: string;
    ...
    per_FechaNacimiento: string | null;
    per_CorreoElectronico: string;
    per_Telefono: string;
    per_Direccion: string;
    per_Sexo: string;
    esActivo: string;
    emp_UsuarioRegistraNombre: string;
    per_FechaRegistra: string | null;
    emp_UsuarioModificaNombre: string;
    per_FechaModifica: string | null;
